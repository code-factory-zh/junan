...
vendor('Wxpay.lib.WxPayConfigInterface');
/**
*
...
class WxPayConfig extends WxPayConfigInterface
{
	...
	{
		return trim(file_get_contents('/cert/app/Appid'));
	}
	public function GetMerchantId()
	{
		return trim(file_get_contents('/cert/app/MerchantId'));
	}
	...
	**/
	...
	{
		$sslCertPath = '/cert/cewr/apiclient_cert.p12';
		$sslKeyPath = '/cert/cewr/apiclient_key.pem';
	}
}
